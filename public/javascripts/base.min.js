...
return $sub_menu.show().animate({left:left,top:"20"},200);}}).bind("mouseleave",function(){var $elem,$sub_menu;$elem=$(this);$sub_menu=$elem.find(".sdt_box");if($sub_menu.length){return $sub_menu.hide().css("left","0px");}});};menuAction=function(item){return $("#"+item).bind('click',function(e){e.preventDefault();$('#content_row').empty();return $.get("/content",function(data){var $content;$('#content_row').append(data);$content=$('#content');$content.css('margin-top','2000px').css('text-align','center').css('margin-bottom','100px');return $.get("/"+item,function(data){$(data).appendTo($('#content_container'));sideMenuHandler();if(item==='menu'){cateringMenu();}
if(item==='photos'){slideshow();}
if(item==='contact'){contactHandler();}
